...
public class PdfParagraphsIdentifier {
   ...
   * @throws IOException 
   */
  public PdfParagraphsIdentifier(TeXFile texFile) throws IOException, TimeoutException {    
    affirm(texFile != null);
...
//          if (currentPdfParagraph != null && currentTexParagraph != null && currentPdfParagraph.getNumLines() > 0) {
