...
#                   x="476.5" y="201.6866">
#                       OrbitalStructureandMagneticOrderinginLayeredManganites:UniversalCorrelationandItsMechanism
#               </text-block>
#               ...
#               <text-line bold="false" font-name="CMR10" font-size="9.96264"
#                   h="41.51103" italic="false" w="754.9349" x="906.5013" y="373.98785">
...
#       </PDFResult>
        ...
        for page in pages:
            ...
            texts_per_page.append(" ".join([x.text for x in text_fragments if x is not None and x.text is not None]))
