...
def evaluate_paragraphs_extraction(gt, actual):
    """
    Computes the accuracy (i.e. the precision and recall) of paragraphs 
    extraction.
    """
    ...
    commons, insertions, deletions = diff(gt, actual, 
        normalize=True, ignore_cases=True, min_similarity=0.1)
